...
mkdir -p "$CA_DIR" "$SITE_DIR" "$TRAEFIK_DIR"
...
http:
  ...
  services:
    $SERVICE_NAME-service:
      loadBalancer:
        servers:
          - url: "http://$SERVICE_NAME-api-$SERVICE_NAME-1:9009"
          - url: "http://$SERVICE_NAME-api-$SERVICE_NAME-2:9009"
