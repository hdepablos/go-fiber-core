...
const providerContextKey = "imputations.provider"
...
func init() {
	batchflow.RegisterPreviewProvider(processTypeName, func(ctx context.Context) (batchflow.PreviewProvider, error) {
		...
		"bulk/process/imputations/start",
		"bulk/process/imputations/dispatch_shards",
		"bulk/process/imputations/process_batch",
		"bulk/process/imputations/finalize",
	)
