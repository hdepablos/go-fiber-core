...
func ResolvePreviewProvider(ctx context.Context, processTypeName string, executionKeys []string) (PreviewProvider, error) {
	return defaultPreviewRegistry.Resolve(ctx, processTypeName, executionKeys)
}
