...
import (
	...
	serviceData "go-fiber-core/internal/services/batchprocess/punitivecursor/data"
	serviceLifecycle "go-fiber-core/internal/services/batchprocess/punitivecursor/lifecycle"
	serviceProcessor "go-fiber-core/internal/services/batchprocess/punitivecursor/processor"
	serviceRuntime "go-fiber-core/internal/services/batchprocess/punitivecursor/runtime"
	serviceSteps "go-fiber-core/internal/services/batchprocess/punitivecursor/steps"
...
func init() {
	...
	batchflow.RegisterPreviewProvider(processTypeName, func(ctx context.Context) (batchflow.PreviewProvider, error) {
		...
		"bulk/process/punitivecursor/start",
		"bulk/process/punitivecursor/dispatch_shards",
		"bulk/process/punitivecursor/process_batch",
		"bulk/process/punitivecursor/finalize",
	)
